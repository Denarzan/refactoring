  ...
  module Operations
    class Card
      ...
      def chose_type(card_type)
        case card_type
        when 'usual' then @account.add_card(Banking::Card::UsualCard.new)
        when 'capitalist' then @account.add_card(Banking::Card::CapitalistCard.new)
        when 'virtual' then @account.add_card(Banking::Card::VirtualCard.new)
        else
          false
        end
      end
